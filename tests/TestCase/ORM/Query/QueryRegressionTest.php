...
class QueryRegressionTest extends TestCase
{
    ...
    public function testComplexTypesInJoinedWhere(): void
    {
        ...
        $this->assertInstanceOf(DateTime::class, $result->comment->updated);
    }
    ...
    public function testComplexNestedTypesInJoinedWhere(): void
    {
        ...
        $result = $query->first();
        $this->assertNotEmpty($result);
        $this->assertInstanceOf(DateTime::class, $result->comment->article->author->updated);
    }
    ...
    public function testComplexTypesInJoinedWhereWithMatching(): void
    {
        ...
        $result = $query->first();
        $this->assertNotEmpty($result);
        $this->assertInstanceOf(DateTime::class, $result->_matchingData['Comments']->updated);
        ...
        $result = $query->first();
        $this->assertNotEmpty($result);
        $this->assertInstanceOf(DateTime::class, $result->_matchingData['Authors']->updated);
    }
    ...
    public function testComplexTypesInJoinedWhereWithInnerJoinWith(): void
    {
        ...
        $result = $query->first();
        $this->assertNotEmpty($result);
        $this->assertInstanceOf(DateTime::class, $result->updated);
    ...
    {
        $table = $this->getTableLocator()->get('Comments');
        $table->updateAll(['updated' => DateTime::now()->addDays(2)], ['id' => 6]);
        $query = $table->find();
